...
/*!
 * \file $RCSfile$
 * \version $Revision: 75254 $
 * \date $Date: 2012-02-29 09:01:06 +0400 (Wed, 29 Feb 2012) $
 * \author $Author: maxdm $
 *
 * \brief XXX
 *
...
struct CPC_CONFIG2_ {//::CPC_CONFIG_ для совместимости со старыми клиентами
    ...
    BOOL fNonSMP;  
    const TCHAR *license;   
    BOOL disableIntegrity;  // Эти поля добавились с CSP 3.6 R3
    HCRYPTMODULE hGOSTCSP;  // для RSA-провайдера на HSM
    BOOL disableShortcuts;  // отключение использования информации о съемных носителях
};
